...
/// </summary>
public class AzureContainerAppGithubAuthenticationOptions : RemoteAuthenticationOptions, IAzureContainerAppAuthenticationOptions
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AzureContainerAppGithubAuthenticationOptions"/> class.
    /// </summary>
    public AzureContainerAppGithubAuthenticationOptions() => CallbackPath = "/.auth/login/github";
